...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('catalog', '0008_alter_hotels_hotel_pic_alter_tours_tour_pic_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='hotels',
            name='hotel_pic',
            field=models.ImageField(default='C:\\Users\\Dooplik\\Desktop\\Education\\Tours\\TourStore\\catalog\\static\\media\\cit.jpg', upload_to='img/hotels_img'),
        ),
        migrations.AlterField(
            model_name='tours',
            name='tour_pic',
